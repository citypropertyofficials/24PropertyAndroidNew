...
data class Property(
    ...
    val geoFormattedAddress: String = "",
    val geoDisplayName: String = "",
    ...
    val showingEndTime: String = "",
    val showingDateTime: String = "",
    val showingAvailability: String = "",

    // ── Property & Legal ─────────────────────────────────────────
    val propertyCondition: String = "",
    val ownership: String = "",
    val plotArea: String = "",
    val plotAreaUnit: String = "",
    ...
    val shedBuiltUpAreaUnit: String = "",
    val builtUpConstructionArea: String = "",
    val builtUpConstructionAreaUnit: String = "",
