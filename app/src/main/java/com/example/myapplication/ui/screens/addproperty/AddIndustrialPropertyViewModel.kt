...
class AddIndustrialPropertyViewModel(
    ...
    private val _uiState = MutableStateFlow(AddIndustrialPropertyUiState())
            ...
            try {
                ...
                _events.emit(
                    AddIndustrialPropertyEvent.ShowMessage(
                        if (isDraft) "Industrial property saved as draft." else "Industrial property added successfully."
                    )
                )
